...
public class MemberVO {
	...
	public String toString() {
		return "MemberVO [mem_id=" + mem_id + ", mem_name=" + mem_name + ", mem_add1=" + mem_add1 + ", mem_add2="
				+ mem_add2 + ", mem_mail=" + mem_mail + ", mem_hp=" + mem_hp + ", mem_pass=" + mem_pass + ", mem_zip="
				+ mem_zip + ", mem_bir=" + mem_bir + "]";
	}
